...
export class RegistroPage implements OnInit, OnDestroy {
  ...
  public foto: any;
  public fotoTomada: "assets/icon/registro.gif";
...
upload() {
  if (this.foto) {
    var uploadTask = this.storage.storage.ref().child('images/'+this.inquilinoLocal.nombre+this.inquilinoLocal.apellido)
      .put(this.foto);
    }
}
