...
export class AmonestacionesPage implements OnDestroy, OnInit {
  ...
  registraAmonestacion() {
    ...
    let email = {
      ...
      subject: 'Amonestación Lerdo de tejada' + this.amonestacionesLocal.tipo,
      body: "<br> Acuerdo:" + this.amonestacionesLocal.descripcion + "<br> Acuerdo:" + this.amonestacionesLocal.acuerdo,
      isHtml: true
    }
