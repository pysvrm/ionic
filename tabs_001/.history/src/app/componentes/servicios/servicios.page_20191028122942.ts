...
export class ServiciosPage implements OnInit {
  ...
  async addServicio(servicio: string) {
    ...
    console.log("Resultado validacion::"+validaInserta);
    console.log("this.checkServicios.tipo::"+this.checkServicios.tipo);
    if (validaInserta == 'true') {
      console.log("Entra 01::");
      if (this.checkServicios.tipo == 'otro') {
        
        if (this.checkServicios.obcervaciones != '') {
          this.obcervacionesAlert();
        } else {
          console.log("Entra 02::");
