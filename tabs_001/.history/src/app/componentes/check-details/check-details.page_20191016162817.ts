...
export class CheckDetailsPage implements OnDestroy, OnInit {
  ...
  async loadInquilino() {
    ...
    console.log("==this.idInquilino2=="+this.inquilinoLocal.nombre)
    this.visitaDepto.getVisitaVisita(this.idInquilino).then(regVisitaVisita => {
    ...
    console.log("==this.visitaLocal.id=="+this.visitaLocal.id)
