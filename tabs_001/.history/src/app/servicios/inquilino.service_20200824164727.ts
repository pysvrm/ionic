...
export class InquilinoService {
  ...
  private inquilinoLocal = {} as InquilinoInterface;
  ...
  actualizaInqquilino( id: string, inquilino: InquilinoInterface){
    try {
...
async agregarInquilino(inquilino: InquilinoInterface){
